  ...
  return (
    <div className='flex h-screen items-center justify-center bg-primary ' >
      ...
      >
        ...
        <Radio.Group className='col-span-2' onChange={(e) => setType(e.target.value)} value={type} >
        ...
        <Link to='/login' className='col-span-2 text-center '  > Already have an account ? Login </Link>
      </Form>
    </div>
  )
}
